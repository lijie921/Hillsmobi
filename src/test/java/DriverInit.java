...
public class DriverInit
{
    ...
    public static void setUp()
    {
        ...
        File app = new File(appDir,"sample_test-debug.apk");
        ...
        cap.setCapability("appPackage","com.hillsmobi.test");//被测app的包名
        cap.setCapability("appActivity","com.hillsmobi.test.MainActivity");//被测app的入口Activity名称
    ...
    public void init()
    {
        ...
        //=======================初始化================================//
        pb.findElement(driver,"com.hillsmobi.test:id/init").click();
